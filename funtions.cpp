...
int yoloV3()
{
	...
	VideoCapture cap(0);//YOLOV3_VIDEO

	if (!cap.isOpened())return -1;


	//coco数据集的名称文件，80类
	string classesFile= "D:/2020/课程/数字图像处理/上课编程/15/coco.names";
	//yolov3网络模型文件
	String yolov3_model = "D:/2020/课程/数字图像处理/上课编程/15/yolov3.cfg";
	//权重
	String weights = "D:/2020/课程/数字图像处理/上课编程/15/yolov3.weights";
...
int openpose()
{
	...
	//读入网络模型和权重文件
	String modelTxt = "D:/2020/课程/数字图像处理/上课编程/15/openpose_pose_coco.prototxt";
	String modelBin = "D:/2020/课程/数字图像处理/上课编程/15/pose_iter_440000.caffemodel";
