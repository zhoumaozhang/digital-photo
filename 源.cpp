...

{
	double gamma = 0.5;
	double lut[256];
	Mat srcMat = imread("D:/2020/课程/数字图像处理/图片/11/chap11_直方图增强.jpg");
	Mat srcMat_grey = imread("D:/2020/课程/数字图像处理/图片/11/chap11_直方图增强.jpg",0);

	cv::Mat dstMat;
	equalizeHist(srcMat_grey, dstMat);//直方图均衡
